...
// Đã cập nhật link mới nhất (AKfycbw_PBiHb41rUtMxOLF5XlXI0NRXhbj1MzMN3vKWW8olmwtEguStzDq5IcDFh5yXakT8mw)
const DEMO_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbw_PBiHb41rUtMxOLF5XlXI0NRXhbj1MzMN3vKWW8olmwtEguStzDq5IcDFh5yXakT8mw/exec";
const STORAGE_KEY_URL = "MY_GOOGLE_SHEET_SCRIPT_URL";

// Cấu trúc payload mở rộng để hỗ trợ nhiều action
interface SheetPayload {
  action: 'create' | 'update' | 'delete' | 'add_column' | 'rename_sheet';
