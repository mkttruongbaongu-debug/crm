        ...
        <div>
          ...
          <div className="relative">
            <textarea
              id="address"
              rows={3}
              className="w-full px-4 py-3 md:px-5 md:py-4 rounded-xl border border-gray-300 focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 outline-none transition-all resize-none text-gray-800 placeholder-gray-400 shadow-inner bg-gray-50/50 text-base"
